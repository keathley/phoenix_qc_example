...
var _user$project$Allocation$decodeResponse = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$Allocation$model = {
	voted: false,
	restaurants: {
		ctor: '::',
		_0: {id: 1, name: 'Thai', votes: 0},
		_1: {
			ctor: '::',
			_0: {id: 2, name: 'Sushi', votes: 0},
			_1: {
				ctor: '::',
				_0: {id: 3, name: 'Burritos', votes: 0},
				_1: {ctor: '[]'}
			}
		}
	},
...
var _user$project$Allocation$Model = F3(
	function (a, b, c) {
		return {voted: a, restaurants: b, phxSocket: c};
	});
var _user$project$Allocation$Restaurant = F3(
	function (a, b, c) {
		return {id: a, name: b, votes: c};
	});
var _user$project$Allocation$User = function (a) {
	return {name: a};
};
var _user$project$Allocation$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Allocation$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$Allocation$PhoenixMsg);
};
var _user$project$Allocation$NewVote = function (a) {
	return {ctor: 'NewVote', _0: a};
};
var _user$project$Allocation$voteForRestaurant = function (rId) {
	var url = A2(
		_elm_lang$core$Basics_ops['++'],
		'/api/restaurants/',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(rId),
			'/votes'));
	var request = A3(_elm_lang$http$Http$post, url, _elm_lang$http$Http$emptyBody, _user$project$Allocation$decodeResponse);
	return A2(_elm_lang$http$Http$send, _user$project$Allocation$NewVote, request);
};
var _user$project$Allocation$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Vote':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Allocation$voteForRestaurant(_p0._0.id)
				};
			case 'NewVote':
				if (_p0._0.ctor === 'Ok') {
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{phxSocket: phxSocket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Allocation$PhoenixMsg, phxCmd)
				};
		}
	});
var _user$project$Allocation$Vote = function (a) {
	return {ctor: 'Vote', _0: a};
};
var _user$project$Allocation$voteButton = function (restaurant) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('restaurant-actions'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('vote-button btn btn-primary'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Allocation$Vote(restaurant)),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$Allocation$restaurantChoice = function (restaurant) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Allocation$voteButton(restaurant),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Allocation$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(_elm_lang$core$List$map, _user$project$Allocation$restaurantChoice, model.restaurants));
};
var _user$project$Allocation$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Allocation$model, _1: _elm_lang$core$Platform_Cmd$none},
		view: _user$project$Allocation$view,
		update: _user$project$Allocation$update,
		subscriptions: _user$project$Allocation$subscriptions
	})();

var Elm = {};
Elm['Allocation'] = Elm['Allocation'] || {};
if (typeof _user$project$Allocation$main !== 'undefined') {
    _user$project$Allocation$main(Elm['Allocation'], 'Allocation', undefined);
}
